export async function getProductType() {
    try {
        ...
        const response = await fetch(
            'http://77.37.44.105:9000/admin_panel/product-type-list/',
            {
                method: 'GET',
                headers: header
            }
...
export async function getSelectedProductType(selectedCategory) {
    try {
        ...
        const response = await fetch(
            `http://77.37.44.105:9000/admin_panel/filter-by-category/?category=${selectedCategory}`,
            {
                method: 'GET',
                headers: header
            }
...
export async function createProductType(newProductType) {
    try {
        ...
        const response = await fetch(
            'http://77.37.44.105:9000/admin_panel/create-product-type/',
            {
                method: "POST",
                headers: header,
                body: formData
...
export async function updateProductType(editProductTypeInfo) {
    ...
    try {
        ...
        const response = await fetch(
            `http://77.37.44.105:9000/admin_panel/${productTypeId}/update-product-type/`,
            {
                method: "PUT",
                headers: header,
                body: formData
...
export async function deleteProductType(productTypeId) {
    try {
        ...
        const response = await fetch(
            `http://77.37.44.105:9000/admin_panel/${productTypeId}/delete-product-type/`,
            {
                method: "DELETE",
                headers: header
            }
...
export async function searchProductType(searchProductTypeInfo) {
    try {
        ...
        const response = await fetch(
            `http://77.37.44.105:9000/admin_panel/product-type-list/?search=${searchProductTypeInfo}`,
            {
                method: "GET",
                headers: header
            }
