    ...
    return (
        <div>
            ...
            <div className="flex justify-center space-x-1 ">
                <button onClick={handleDailyData} className={`px-4 py-2 ${active === "daily" ? "bg-[#BB1140]" : "bg-[#b25670]"}  hover:bg-[#BB1140] border border-black text-white rounded`}>Daily</button>
                <button onClick={handleWeeklyData} className={`px-4 py-2 ${active === "weekly" ? "bg-[#BB1140]" : "bg-[#b25670]"}  hover:bg-[#BB1140] border border-black text-white rounded`}>Weekly</button>
                <button onClick={handleMonthlyData} className={`px-4 py-2 ${active === "monthly" ? "bg-[#BB1140]" : "bg-[#b25670]"}  hover:bg-[#BB1140] border border-black text-white rounded`}>Monthly</button>
                <button onClick={handleYearlyData} className={`px-4 py-2 ${active === "yearly" ? "bg-[#BB1140]" : "bg-[#b25670]"}  hover:bg-[#BB1140] border border-black text-white rounded`}>Yearly</button>
            </div>
            ...
            <div className="w-full md:w-4/5 mx-auto mt-4 flex flex-col">
                ...
                <Link href={`orderReports/${active}Report`} className="mt-3 text-blue-500 underline ml-auto">View more ...</Link>
            </div>
        </div>
    )
}
