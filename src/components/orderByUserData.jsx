...
import { getOrderByUserData, getOrderByUserReportAsync, getSelectedUserName } from "../redux/slice/report/reportSlice";
...
export default function OrderByUserData() {
    ...
    React.useEffect(() => {
        if(params.userId){
            dispatch(getOrderByUserReportAsync(params.userId));
        }
